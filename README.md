...
|fetchId|String255|O|-|このオブジェクトはfetchItemsによるリクエストを受けた場合のみ記述する必要があります。Hatoholサーバーから送られたどのリクエストに対するレスポンスであるかを示すIDです。fetchItemsのparams内のfetchIdオブジェクトの値をここに入れてください|
